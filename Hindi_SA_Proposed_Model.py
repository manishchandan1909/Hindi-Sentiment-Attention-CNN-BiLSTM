...
Original file is located at
    https://colab.research.google.com/drive/1xxQH3ncFtxvZ8C1tv5OIuR9soPlpZl-2
"""
...
def predict_sentiment(sentence, model, vocabulary, max_length, label_encoder):
    """Predicts the sentiment of a Hindi sentence using the trained model.

    Args:
        sentence: The Hindi sentence to analyze.
        model: The trained Keras model.
        vocabulary: The word vocabulary used in the model.
        max_length: The maximum length of input sequences.
        label_encoder: The LabelEncoder object used for encoding sentiments.

    Returns:
        The predicted sentiment label and inference time.
    """
